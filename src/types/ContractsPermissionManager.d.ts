...
interface ContractsPermissionManagerInterface extends ethers.utils.Interface {
  functions: {
...
export class ContractsPermissionManager extends Contract {
  ...
  interface: ContractsPermissionManagerInterface;
